...
describe('WorkspaceService', () => {
  ...
  it('getAll should return workspaces', async () => {
    ...
    vi.mocked(window.api.workspace.getAll).mockResolvedValue({
      success: true,
      data: mockWorkspaces,
    });
  ...
  it('getById should return workspace', async () => {
    ...
    vi.mocked(window.api.workspace.getById).mockResolvedValue({
      success: true,
      data: mockWorkspace,
    });
  ...
  it('create should return new workspace', async () => {
    ...
    vi.mocked(window.api.workspace.create).mockResolvedValue({
      success: true,
      data: mockWorkspace,
    });
  ...
  it('update should return updated workspace', async () => {
    ...
    vi.mocked(window.api.workspace.update).mockResolvedValue({
      success: true,
      data: mockWorkspace,
    });
  ...
  it('update should throw on failure', async () => {
    ...
    await expect(workspaceService.update('w1', { name: 'A' })).rejects.toThrow(
