...
export class PostmanParser {
   ...
   */
  static parseUrl(url: PostmanUrl | string | undefined): string {
    if (!url) return '';
   ...
   */
  static parseMethod(method: string | undefined): HttpMethod {
   ...
   */
  static parseHeaders(headers: PostmanHeader[] | undefined): RequestHeader[] {
    if (!headers) return [];
   ...
   */
  static parseBody(body: PostmanBody | undefined): RequestBody {
   ...
   */
  static parseAuth(auth: PostmanAuth | undefined): Authentication {
    if (!auth) {
      return { type: 'none' };
    }
      ...
      case 'oauth2': {
        ...
        return {
          ...
          oauth2: {
            ...
            redirectUri:
              this.getAuthValue(auth.oauth2, 'redirect_uri') || 'http://localhost:8080/callback',
   ...
   */
  static parseScripts(events: PostmanEvent[] | undefined): {
